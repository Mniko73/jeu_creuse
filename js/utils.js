// Classe PerlinNoise (si pas déjà définie ailleurs)
...
// Fonction de bruit simple (fallback si pas de Perlin)
export function simpleNoise(x, y, seed) {
  const n = Math.sin((x + y + seed) * 57) * 43758.5453123;
